      ...
      <Card className="w-full max-w-3xl shadow-2xl border border-gray-300 dark:border-gray-700 rounded-2xl p-6">
        <CardHeader className="text-center space-y-3">
          <CardTitle className="text-4xl font-extrabold tracking-tight">
            Welcome to <span className="text-blue-600">IntelliCheck</span> 🧠
          </CardTitle>
        ...
        <CardContent className="space-y-6 text-center text-lg">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Whether you are revising for exams or just having fun — <span className="text-blue-600 font-semibold">IntelliCheck</span> got you covered.
          </p>
        </CardContent>
