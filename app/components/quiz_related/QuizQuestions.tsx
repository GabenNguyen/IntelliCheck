...
export default function QuizQuestions({
  ...
  if (!currentQuestion || !currentQuestion.options) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-violet-950/20">
        <Spinner />
      </div>
    );
  }
  ...
  return (
    <div className="flex justify-center items-start min-h-screen p-4 md:p-8 bg-gradient-to-br from-slate-50 via-white to-violet-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-violet-950/20 font-sans">
      <div className="w-full max-w-3xl flex flex-col pt-8 md:pt-12">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-6 md:p-10 shadow-xl shadow-violet-500/10 border border-violet-500/20 relative overflow-hidden">
                  ...
                  return (
                    <button
                      ...
                      className={`group relative w-full text-left flex items-center p-4 md:p-5 rounded-2xl border-2 transition-all duration-200 outline-none
                        ${
                          isSelected
                            ? "border-violet-500 bg-gradient-to-r from-violet-500 to-indigo-500 text-white dark:border-violet-400"
        ...
        <div className="flex items-center justify-between mt-8 w-full gap-4">
          ...
          <Button
            onClick={handleNext}
            className="h-14 px-8 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-medium transition-all shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 disabled:opacity-50"
          >
