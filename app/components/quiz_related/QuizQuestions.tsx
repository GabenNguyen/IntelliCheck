  ...
  return (
    <Card className="w-full max-w-3xl shadow-2xl border border-gray-300 dark:border-gray-700 rounded-2xl p-6">
        ...
        <AnimatePresence mode='wait'>
          ...
          >
            {/* Make question scrollable */}
            <CardTitle className='text-3xl font-bold mt-3 text-center max-h-40 overflow-auto'>
              {currentQuestion.question}
            </CardTitle>

            {/* Make options scrollable if too many */}
            <CardContent className="grid gap-4 mt-4 max-h-96 overflow-auto">
