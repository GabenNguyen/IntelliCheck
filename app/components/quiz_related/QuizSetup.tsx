            ...
            <form onSubmit={handleStartQuiz}>
              <CardContent className="space-y-6 px-6 md:px-12 pb-8">
                ...
                <div className="space-y-2">
                  <Label htmlFor='topic' className='flex items-center gap-2 text-slate-700 dark:text-slate-300 font-semibold text-base'>
                ...
                {/* Difficulty Select */}
                <div className="space-y-2">
                  <Label htmlFor='difficulty' className='flex items-center gap-2 text-slate-700 dark:text-slate-300 font-semibold text-base'>
                    <span className="text-lg">🎯</span> Difficulty
                  </Label>
                  <Select value={difficulty} onValueChange={(difficulty) => setDifficulty(difficulty)}>
                      <SelectTrigger id='difficulty' className="h-12 border-2 border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-slate-50 dark:bg-slate-800/50 cursor-pointer hover:border-slate-300 dark:hover:border-slate-600">
                      ...
                      <SelectContent className="rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                        <SelectGroup>
                          <SelectLabel className="text-slate-500 dark:text-slate-400 font-semibold">Difficulty Level</SelectLabel>
                              <SelectItem value="easy" className='cursor-pointer hover:bg-green-50 dark:hover:bg-green-950/20 rounded-lg my-1 focus:bg-green-100 dark:focus:bg-green-900/30'>
                                <span className="flex items-center gap-2"><span className="text-green-600 dark:text-green-400">●</span> Easy</span>
                              </SelectItem>
                              <SelectItem value="medium" className='cursor-pointer hover:bg-yellow-50 dark:hover:bg-yellow-950/20 rounded-lg my-1 focus:bg-yellow-100 dark:focus:bg-yellow-900/30'>
                                <span className="flex items-center gap-2"><span className="text-yellow-600 dark:text-yellow-400">●</span> Medium</span>
                              </SelectItem>
                              <SelectItem value="hard" className='cursor-pointer hover:bg-orange-50 dark:hover:bg-orange-950/20 rounded-lg my-1 focus:bg-orange-100 dark:focus:bg-orange-900/30'>
                                <span className="flex items-center gap-2"><span className="text-orange-600 dark:text-orange-400">●</span> Hard</span>
                              </SelectItem>
                              <SelectItem value="asian" className='cursor-pointer hover:bg-red-50 dark:hover:bg-red-950/20 rounded-lg my-1 focus:bg-red-100 dark:focus:bg-red-900/30'>
                                <span className="flex items-center gap-2"><span className="text-red-600 dark:text-red-400">●</span> Asian</span>
                              </SelectItem>
                          </SelectGroup>
                      </SelectContent>
                  </Select>
                ...
                <div className="space-y-2">
                  <Label htmlFor='numOfQuestions' className='flex items-center gap-2 text-slate-700 dark:text-slate-300 font-semibold text-base'>
                  ...
                  <Input 
                      ...
                      required
                  />
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 ml-1">Choose between 1-50 questions</p>
                </div>
              </CardContent>
